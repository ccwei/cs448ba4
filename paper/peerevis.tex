...
where the user can select one or multiple teams using different ways of filtering.

The user can select one team by clicking one of the small block on the stacked bar
