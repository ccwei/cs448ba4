...
\begin{figure}[!t]
\centering
\includegraphics[width=0.7\columnwidth]{images/review-form-old}
...
We use multiple coordinated views techniques to show data in different representations which
enable users to interact, explore and understand intricate data \cite{State-of-the-art}.
Furthermore, we also use text visualization techniques, including word count list and tag cloud, which are often used to visualize and understand various large text data \cite{TagClouds} [http://www.wordcount.org/main.php].
...
\begin{figure*}[t]
\centering
\includegraphics[width=1.7\columnwidth]{images/phrase-list}
\includegraphics[width=1.7\columnwidth]{images/keyword-list}
\includegraphics[width=1.7\columnwidth]{images/clouds}
...
\begin{figure}[]
\centering
\includegraphics[width=\columnwidth]{images/modal}
...
\begin{figure*}[t]
\centering
\includegraphics[width=1.7\columnwidth]{images/ind-review-view}
...
consisting of two main parts as shown in Figure \ref{fig:ind-view}. First part on the left is a list of small
