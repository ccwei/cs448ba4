...
In aggregate view as shown in Figure \ref{fig:aggregate-view}, the text feedbacks for the selected teams are shown separately categorized by their types from feedback capture grid.
