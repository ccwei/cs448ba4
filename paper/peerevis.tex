...
multiples to navigate through the original review list. Each original review item in the list contains the scores distribution of the rubrics from the original review form (Figure \ref{fig:review-form}, the average score, and the feedback capture grid as also shown in the
original form.
