...
Another possible improvement is to enhance system’s ability to compare
different group of students by demographic such as GPA, academic major, or
nationality.

Finally, we plan to integrate this tool into the Venture Lab platform to evaluation
from real instructor usage in online classes.
