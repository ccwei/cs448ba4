...
;
        ...
        superfish.b.ip="128.12.197.54";
        superfish.b.userid="fastest00_fastestchrome_1_";
        superfish.b.appVersion="12.1.0.1";
...
superfish.b.bl='abajournal.baidu.bedandbreakfast.bernadettelivingston.beso.birdviewprojects.bizrate.booking.cam4.cj.cnn.crunchyroll.cvsphoto.dcinside.deviantart.drudgereport.facebook.flickr.furniture-quest.history.hotmail.imdb.imvu.linkedin.lolhehehe.lowpriceshopper.microsoft.msn.myspace.netflix.nytimes.pandora.picasa.pinterest.politico.polybags4less.pricegrabber.publicstorage.qq.rue89.salon.sfgate.shopzilla.shutterfly.spardeingeld.usamm.venturebeat.westsiderentals.wired.yankodesign.yahoo.youtube.';
...
//        spsupport.log("send txt request");
    ...
    validDispl: function(im) {
        var cndM = im.width > this.dim && im.height > this.dim;
        if (cndM && parseInt(this.imgPos.y + im.height - 45) < this.lvl) {
            return 1;
        }
        return 0;
    },
...
superfish.publisher.extractTxt = function(img) {
    ...
    oi: function(ind) {
        ...
        t.pi("-9999" + xdMsgDelimiter + t.se[ind]);
    },
